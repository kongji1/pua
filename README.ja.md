...
```bash
npx skills add kongji1/pua --skill pua-ja
```
...
curl -o ~/.codex/skills/pua-ja/SKILL.md \
  https://raw.githubusercontent.com/kongji1/pua/main/codex/pua-ja/SKILL.md
...
curl -o .cursor/rules/pua-ja.mdc \
  https://raw.githubusercontent.com/kongji1/pua/main/cursor/rules/pua-ja.mdc
```
...
curl -o .kiro/steering/pua-ja.md \
  https://raw.githubusercontent.com/kongji1/pua/main/kiro/steering/pua-ja.md
```
...
curl -o .kiro/skills/pua-ja/SKILL.md \
  https://raw.githubusercontent.com/kongji1/pua/main/skills/pua-ja/SKILL.md
```
...
curl -o .claude/agents/pua-enforcer.md \
  https://raw.githubusercontent.com/kongji1/pua/main/agents/pua-enforcer-ja.md
```
